...
# Ingredients required for chocolate chip cookies

flour_needed = 0.5 # kg

sugar_needed = 0.3 # kg

butter_needed = 0.2 # kg

eggs_needed = 2 # eggs

vanilla_extract_needed = 0.01 # liter

chocolate_chips_needed = 0.2 # kg
...
total_cost = total_flour_cost + total_sugar_cost + total_butter_cost + total_eggs_cost + total_vanilla_extract_cost + total_chocolate_chips_cost 
...
# Ingredients required for cinnamon raisin bread
...
milk_needed = 0.5 # liter

yeast_needed = 0.02 # oz

salt_needed = 0.01 # kg

cinnamon_needed = 0.02 # kg

raisins_needed = 0.15 # kg
...
total_cost = total_flour_cost + total_sugar_cost + total_butter_cost + total_milk_cost + total_yeast_cost + total_salt_cost + total_cinnamon_cost + total_raisins_cost
...
butter_needed = 0.15 # kg

milk_needed = 0.3 # liter

eggs_needed = 2 # eggs

baking_powder_needed = 12 # grams

vanilla_extract_needed = 0.01 # liter

chocolate_chips_needed = 0.15 # kg
